...
def count_price(sheetfile1, values):
    ...
    for student_number in range(1, 3):
        for sheet_name in sheet_names:
            ...
            file_save_sheet['Q'+str(row_number)] = kil_indiv_zavd
